...
import map.exercicio_proposto03.Contato;
...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
        ...
        set1.forEach(entry -> System.out
                .println(entry.getKey() + " - " + entry.getValue().getNome() +
